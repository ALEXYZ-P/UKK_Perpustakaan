                                    ...
                                    <div class="tab-pane fade" id="account-detail" role="tabpanel" aria-labelledby="account-detail-tab">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form action="{{ route('user.update', $user->id) }}" method="POST" name="enq">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            <label>First Name <span class="required">*</span></label>
                                                            <input required="" class="form-control square" name="name" type="text" value="{{ $user->nama }}" >
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label>Last Name <span class="required">*</span></label>
                                                            <input required="" class="form-control square" name="phone" value="{{ $user->nama }}">
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label>Username <span class="required">*</span></label>
                                                            <input required="" class="form-control square" name="dname" type="text" value="{{ $user->username }}">
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input required="" class="form-control square" name="name" type="text" value="{{ $user->notlp }}" >
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input required="" class="form-control square" name="dname" type="text" value="{{ $user->alamat }}">
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label>Tnaggal Lahir <span class="required">*</span></label>
                                                            <input required="" class="form-control square" name="email" type="email" value="{{ $user->tgl_lahir }}">
                                                        </div>
