                                            ...
                                            <div class="product-cart-wrap mb-30">
                                                ...
                                                <div class="product-content-wrap">
                                                    <div class="product-category">
                                                        ...
                                                        @foreach ($i->buku->kategori()->get() as $item)
                                                            {{$item->nama}}
                                                        @endforeach</a>
                                                    </div>
                                                    ...
                                                    <div class="product-price">
                                                        ...
                                                        <div class="product-action-1 show">
                                                            ...
                                                            <input type="hidden" name="id_buku" class="id_buku" value="{{ $i->buku->id }}">
                                                            <style>
                                                                .icon {
                                                                    color: red;
                                                                }
                                                            ...
                                                            @foreach ($koleksi as $like)
                                                                @if ($like->id_user == Auth::user()->id)
                                                                    @if ($like->id_buku == $i->buku->id)
                                                                        @php
                                                                            $liked = true;
                                                                        @endphp
                                                                        <a aria-label="Add To Like"
                                                                            data-id_user="{{ Auth::user()->id }}"
                                                                            data-id_buku="{{ $i->buku->id }}" id="like"
