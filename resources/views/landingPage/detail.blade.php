                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-info">
                                        ...
                                        {{-- <div class="product_sort_info font-xs mb-30">
                                            <ul>
                                                <li class="mb-10"><i class="fi-rs-crown mr-5"></i> {{$data->created_at}}</li>
                                                <li class="mb-10"><i class="fi-rs-refresh mr-5"></i> {{ $data->penulis}}</li>
                                                <li><i class="fi-rs-credit-card mr-5"></i>{{ $data->penerbit}}</li>
                                                <li><i class="fi-rs-credit-card mr-5"></i>{{ $data->tahun_terbit}}</li>
                                            </ul>
                                        </div> --}}
                                        ...
                                        <div class="attr-detail attr-size">
                                            ...
                                            <ul class="list-filter size-filter font-small">
                                                <li><h6>Ditambahkan pada </h6></li>
                                                <li><span></span><h6>Penulis</h6></li>
                                                <li><span></span><h6>Penerbit</h6></li>
                                            </ul> --}}
                                        </div>
                                        <div class="bt-1 border-color-1 mt-30 mb-30"></div>
                                        <div class="detail-extralink">
                                            {{-- <input type="hidden" class="form-control" name="id_user" value="{{ Auth::user()->id }}" hidden>
                                        ...
                                        {{-- <ul class="product-meta font-xs color-grey mt-50">
                                            ...
                                            <li>Stok:<span class="in-stock text-success ml-5">{{ $data->stok}}</span></li>
                                        </ul> --}}
                                    </div>
                                    <!-- Detail Info -->
                                </div>
