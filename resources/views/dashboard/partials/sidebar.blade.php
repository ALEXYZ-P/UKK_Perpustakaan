        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item  {{ Route::is('user.index') || Route::is('member.index') || Route::is('buku.index') || Route::is('kategori.index') || Route::is('relasiK.index') || Route::is('akses.index') || Route::is('role.index') || Route::is('invoice.index') ? 'menu-open' : ''}} ">
                        ...
                        @endforeach
                                ...
                                @foreach ($role_menu as $i)
                         @if ($i->akses->menu == "Anggota")
                                <li class="nav-item">
                                    <a href="{{ route('member.index')}}" class="nav-link {{ Route::is('member.index') ? 'active' : ''}}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Anggota</p>
                                    </a>
                                </li>
                        ...
                        @endforeach
                                ...
                                @foreach ($role_menu as $i)
                         @if ($i->akses->menu == "Kategori")
                                <li class="nav-item">
                                    <a href="{{ route('kategori.index')}}" class="nav-link {{ Route::is('kategori.index') ? 'active' : ''}}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Kategori</p>
                                    </a>
                                </li>
                        ...
                        @endforeach
                                ...
                                @foreach ($role_menu as $i)
                         @if ($i->akses->menu == "Relasi Kategori")
                                <li class="nav-item">
                                    <a href="{{ route('relasiK.index')}}" class="nav-link {{ Route::is('relasiK.index') ? 'active' : ''}}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Relasi Kategori</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('peminjaman.index')}}" class="nav-link {{ Route::is('peminjaman.index') ? 'active' : ''}}">
