        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <a href="{{ route('pengembalian.index') }}" type="button" class="btn btn-warning mb-3">Kembali</a>
                        <form action="{{ route('pengembalian.update', $data->id)}}" method="POST">
                            ...
                            <input type="text" class="form-control" name="tgl_peminjaman" id="" value="{{ $data->tgl_peminjaman }}" readonly>
